...
return win;
},prompt:function(_29c,msg,fn,isPassword){
    var _29d = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>" + "<div><input class=\"messager-input\" type=\"" +( isPassword?"password":"text")+ "\"/></div>";
var _29e={};
