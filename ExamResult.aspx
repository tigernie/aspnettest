<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamResult.aspx.cs" Inherits="Web.ExamResult" %>
            ...
            <tbody>
                <tr>
                    <td width="800" height="120" align="center" bgcolor="#216397">
                        <strong><span style="font-size: 30px; color: #ffffff">反假货币培训考试<br />成绩查询</span>
                                        ...
                                        <table width="0" align="center" class="search_table"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="ObjecScore" runat="server" Text="Label"></asp:Label>
                                                    </td>
                                                    </tr>
                                                <tr>
                                                   <td>实操成绩
                                                    ...
                                                    <td>
                                                        <asp:Label ID="TheoryScore" runat="server" Text="Label"></asp:Label>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
